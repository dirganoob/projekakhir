...
<div class="content-wrapper">
    ...
    <script src="summernote-bs5.js"></script>
        <form action="/insertMa" method="GET" enctype="">
            <div class="mb-3">
             ...
             <textarea class="bg-dark" name="deskripsi" id="summernote" cols="30" rows="10"></textarea>
              <div class="mb-3">
                <input type="date" placeholder="tanggal mulai" name='tanggalMulai' class="form-control" required>
              </div>
              <div class="mb-3">
                <input type="date" placeholder="tanggal selesai" name='tanggalSelesai' class="form-control" >
              </div>
              <div class="mb-3">
