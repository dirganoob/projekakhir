...
<div class="content-wrapper">
   ...
   <div class="col-6 me-2">
    ...
    @if (session()->get('success'))
            ...
            @endif
              <form method = "GET" action="{{url('showdataD')}}">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/editD/{{ $row->id }}" method="post">
                    @csrf
                    <div class="mb-3"><input type="text" name="nama" placeholder="nama"value="{{$row->nama}}">
                </div>
                  <div class="mb-3">
                  <input type="text" name="nip" placeholder="nim"value="{{$row->nip}}"></div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                  <input type="file" name="foto"value="{{$row->foto}}"></div>
                  </div>
                  <div>
                    <img src="{{asset('images/'.$row->foto)}}" alt="" style="width:40px;">
</div>
