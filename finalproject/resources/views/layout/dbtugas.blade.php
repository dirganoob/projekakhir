            ...
            @endif
              ...
              <div class="col-mt-2">
                ...
                <div class="col-mt-2">
                    ...
                    @foreach($base as $p)
                    <option value="{{$p->id}}">{{$p->tanggalpembuatan}}</option>
                    @endforeach
                    </select>
                </div>
                ...
                <div class="col-mt-2">
                    ...
                    <option value="">Pilih Tanggal</option>
                    @foreach($base as $p)
                    <option value="{{$p->id}}">{{$p->batasakhir}}</option>
                    @endforeach
                    </select>
                </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-{{$row->id}}">
                                ...
                                <a type="button" href="/deleteT/{{$row->id}}"class="btn btn-warning mt-2" onclick="return confirm('Yakin hapus data?')">Deleted</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/editT/{{ $row->id }}" method="post">
                    @csrf
                  ...
                  <div class="mb-3">
                  <input type="date" name="batasakhir" placeholder="batasakhir"value="{{$row->batasakhir}}"></div>
